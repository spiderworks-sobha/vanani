			...
			<div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a href="{{route('admin.events.media.edit', [encrypt($item->id), $type])}}" class="webadmin-open-ajax-popup item-meida" title="Update Media Details" 
                    data-popup-size="large"><i class="fas fa-pencil-alt"></i></a>
                        <a href="{{route('admin.events.media.destroy', [encrypt($item->id)])}}" class="gallery-item-remove ml-2" ><i class="fas fa-trash"></i></a>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Embed Url: {{$item->youtube_url}}</p>
                            <hr>
                            <div class="text-center">
                                <a href="{{route('admin.events.media.edit', [encrypt($item->id), 'Image'])}}" class="webadmin-open-ajax-popup item-meida" title="Update Media Details" 
                    data-popup-size="large"><i class="fas fa-pencil-alt"></i></a>
                                <a href="{{route('admin.events.media.destroy', [encrypt($item->id)])}}" class="gallery-item-remove ml-2" ><i class="fas fa-trash"></i></a>
                            </div>
                        </div>
