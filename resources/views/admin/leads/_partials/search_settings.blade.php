                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="leads.lead_type" class="form-control datatable-advanced-search webadmin-select2-input">
                                    <option value="">All</option>
                                    @if(isset($search_settings['lead_types']))
                                        @foreach($search_settings['lead_types'] as $lead_type)
                                            <option value="{{$lead_type->lead_type}}">{{$lead_type->lead_type}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
