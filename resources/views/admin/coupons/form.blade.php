                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route($route.'.index') }}">All Coupons</a></li>
                                            <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif Coupon</li>
                                        </ol>
                                    </div><!--end col-->
                                                ...
                                                <div class="card-body">
                                                    <div data-simplebar>
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label>Listing</label>
                                                                <select name="listing_id" class="w-100 webadmin-select2-input form-control" data-select2-url="{{route('admin.select2.list')}}">
                                                                    @if($obj->listing_id)
    ...
    <script type="text/javascript">
        var validator = $('#InputFrm').validate({
              ...
              messages: 
              {
                ...
                "listing_id": "Listing cannot be blank",
              },
        });
    </script>
@parent
