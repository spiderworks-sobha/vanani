                            ...
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        @else
                                            <h4 class="page-title">Create new Amenity</h4>
                                        @endif
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            <li class="breadcrumb-item"><a href="{{ route($route.'.index') }}">All Amenities</a></li>
                                            <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif Amenity</li>
                                        </ol>
                                    </div><!--end col-->
