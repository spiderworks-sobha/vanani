    <div class="col-md-4 mb-2 gallery-item" id="gallery-item-{{$package_media_id}}">
			...
			<div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a href="{{route('admin.packages.media.edit', [encrypt($package_media_id)])}}" class="webadmin-open-ajax-popup item-meida" title="Update Media Details" 
                    data-popup-size="large"><i class="fas fa-pencil-alt"></i></a>
                        <a href="{{route('admin.packages.media.destroy', [encrypt($package_media_id)])}}" class="gallery-item-remove ml-2" ><i class="fas fa-trash"></i></a>
                    </div>
