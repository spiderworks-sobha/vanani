                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group col-md-12">
                                                        <label>Title</label>
                                                        <input type="text" class="form-control" name="featured_title" id="featured_title" value="{{$obj->featured_title}}">
                                                    </div>
                                                    @include('admin.media.set_file', ['file'=>$obj->featured_section_image, 'title'=>'Featured Settings Image', 'popup_type'=>'single_image', 'type'=>'Image', 'holder_attr'=>'featured_section_image_id'])
                                                </div>
                                            </div>
