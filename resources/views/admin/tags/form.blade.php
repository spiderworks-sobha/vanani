                            ...
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        @else
                                            <h4 class="page-title">Create new Tag</h4>
                                        @endif
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            <li class="breadcrumb-item"><a href="{{ route($route.'.index') }}">All Tags</a></li>
                                            <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif Tag</li>
                                        </ol>
                                    </div><!--end col-->
                            ...
                            @if($obj->id)
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body row">
                                                    ...
                                                    @endfieldshow
                                                    @fieldshow(tags-meta_description)
                                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @fieldshow(tags-featured_image_id)
                                            <div class="card">
                                                <div class="card-header">
                                                    Featured Image
                                                </div>
                                            ...
                                            @endfieldshow
                                            @fieldshow(tags-banner_image_id)
                                            <div class="card">
                                                <div class="card-header">
                                                    Banner Image
                                                </div>
