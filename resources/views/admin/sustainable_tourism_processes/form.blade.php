                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        @if($obj->id)
                                            <h4 class="page-title">Edit Sustainable Tourism Process</h4>
                                        @else
                                            <h4 class="page-title">Create new Sustainable Tourism Process</h4>
                                        @endif
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            <li class="breadcrumb-item"><a href="{{ route($route.'.index') }}">All Sustainable Tourism Processes</a></li>
                                            <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif Sustainable Tourism Process</li>
                                        </ol>
                                    </div><!--end col-->
