<div id="form-vertical" class="form-horizontal form-wizard-wrapper">
    ...
    <fieldset class="row">
        <div class="form-group col-md-12">
            ...
            <input type="text" name="content[detail_page_highlights_title]" class="form-control" @if($obj->content && isset($obj->content['detail_page_highlights_title'])) value="{{$obj->content['detail_page_highlights_title']}}" @endif >
        </div>
        <div class="form-group col-md-12">
