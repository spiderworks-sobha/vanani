                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">@if($parent_data) Sub-Pages of {{$parent_data->name}} @else All Pages @endif</h4>
                                        <ol class="breadcrumb">
                                ...
                                <div class="card-body">
                                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="nosort nosearch table-width-10 @fieldshow(pages-parent_id) @else nodisplay @endfieldshow" >Sub Pages</th>
    ...
    <script>
        ...
        $(function(){
            $(document).on('click', '.delete_have_child', function(){
                $.alert('Sorry! You cannot delete this category, to delete it please delete all its sub pages.');
            })
        })
    </script>
    @parent
