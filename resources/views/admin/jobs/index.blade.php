                                ...
                                <div class="card-body">
                                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="table-width-120">Job Code</th>
                                            <th class="table-width-120">Job Name</th>
                                            <th class="table-width-120">Slug</th>
                                            <th class="nosearch table-width-10 text-center @fieldshow(jobs-priority) @else nodisplay @endfieldshow">Priority</th>
