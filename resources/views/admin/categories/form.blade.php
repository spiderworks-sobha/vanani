                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{route($route.'.index', [$parent])}}">All Categories</a></li>
                                            <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif Category</li>
                                        </ol>
                                    </div><!--end col-->
                            ...
                            @if($obj->id)
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                                ...
                                                <div class="card-body">
                                                    <div data-simplebar>
                                                        <div class="row m-0">
                                                            ...
                                                            @endfieldshow
                                                            @fieldshow(categories-category_type)
                                                                @php
                                                                    $category_types = Config('admin.category_types');
                                                                @endphp
                                                                @if($category_types)
                                                                <div class="form-group col-md-6">
                                                                    <label class="">Category Type</label>
                                                                    <select name="category_type" class="w-100 webadmin-select2-input" data-placeholder="Select a Category Type">
                                                                        <option value="">-- No Category Type --</option>
                                                                        @foreach($category_types as $type)
                                                                            <option value="{{$type}}" @if($obj->category_type == $type) selected="selected" @endif>{{$type}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                @endif
                                                            @endfieldshow
                                                            @fieldshow(categories-parent_id)
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select name="parent_id" class="w-100 webadmin-select2-input" data-placeholder="Select a Parent Category">
                                                                    ...
                                                                    @foreach($categories as $category)
                                                                        ...
                                                                        @include('admin._partials.category', ['category'=>$category, 'depth'=>1, 'selected'=>$parent])
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            @endfieldshow
                                                            @fieldshow(categories-short_description)
                                                            <div class="form-group col-md-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body row">
                                                    ...
                                                    @endfieldshow
                                                    @fieldshow(categories-meta_description)
                                                    <div class="form-group col-md-6">
                                            ...
                                            @endfieldshow
                                            @fieldshow(categories-extra_data)
                                            <div class="card">
                                                <div class="card-header">
                                                    Extra Data
                                                </div>
                                                <div class="card-body row">
                                                    @fieldshow(categories-og_title)
                                                    <div class="form-group col-md-12">
                                                        <label>OG Title</label>
                                                        <input type="text" class="form-control" name="og_title" id="og_title" value="{{$obj->og_title}}">
                                                    </div>
                                                    @endfieldshow
                                                    @fieldshow(categories-og_description)
                                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-md-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="row m-0">
                                                        <div class="form-group w-100  mb-2">
                                                            ...
                                                            @fieldshow(categories-is_featured)
                                            ...
                                            @fieldshow(categories-faq)
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body text-center">
                                                        <a href="{{route('admin.faq.index', [$obj->id, 'Category'])}}" class="webadmin-open-ajax-popup btn btn-sm btn-warning" title="SET FAQ" data-popup-size="large">@if(count($obj->faq)>0) Update FAQ @else Add FAQ @endif</a>
                                                    </div>
                                                </div>
                                                @endif
                                            @endfieldshow
                                            ...
                                            @endfieldshow
                                            @fieldshow(categories-featured_image_id)
                                            <div class="card">
                                                <div class="card-header">
                                                    Featured Image
                                                </div>
